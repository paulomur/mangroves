...
This process helps to obtain classes more "pure" pixels and discard outliers.


## Indices and an object-based classifier

We calculate a set of different relevant spectral metrics from the exported asset.
Relevant vegetation indices and GLCM textural metrics for mapping mangroves were calculate.
...
User can modify MVI for any other index or metric.
