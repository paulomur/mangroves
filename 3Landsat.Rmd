  ...
  var image = percentil
   ...
   // image = image.set('composite_year', oldIndex).clip(featureCol);
    ...
    Export.image.toAsset({
      ...
      assetId: 'YourCollectionName/percentiles_' + year, 
      crs: outProj,
      scale: 30,
      maxPixels: 1e13,
      region: featureCol,
...
Once you save the fitted image data and the percentiles we can combine them into a final ImageCollection to run th classification proces for each 3-year composite. 
