...
```{r my-fig2, out.width = "450px",fig.cap="LandTrendr segmentation example", echo=FALSE, message=FALSE}
...
```{r my-fig3, out.width = "150%", fig.cap="Image with remaing clouds (left), original image (right)", echo=FALSE, message=FALSE}
...
```{r my-fig4, out.width = "30%", fig.cap="Epochs", echo=FALSE, message=FALSE}
...
After you remove bad images and change parameters you can export the fitted image plus the percentiles as an ImageCollection. Given this process is very demanding computationally it might takes some minutes after you can  export the data. You should see something like this:

```{r my-fig5, out.width = "80%", fig.cap="Tasks", echo=FALSE, message=FALSE}
